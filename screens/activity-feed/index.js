      ...
      <View style={styles.container}>
        ...
        <View style={styles.followingSection}>
          <View style={styles.textarea}>
            ...
            <Text>{"Past Drone Footage"}</Text>
          </View>
          <View style={styles.textarea}>
            <Image style={styles.followingIcon} source={require("./assets/following.png")} />
            <Text style={styles.followingText}>{"EMS Services connected (911 is automatic)"}</Text>
          </View>
        </View>
...
const Post = props => {
  return <TouchableHighlight onPress={props.onPress} style={postStyles.galleryPost} underlayColor='#DDDDDD'>
        <Image style={postStyles.editIcon} source={{
      uri: "https://th.bing.com/th/id/OIP.3OoRpMS-htluHbewpVdKuwHaE8?pid=ImgDet&rs=1"
    }} />
    </TouchableHighlight>;
};
