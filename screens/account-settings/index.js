  ...
  return <SafeAreaView style={styles.container}>
      <ScrollView>
        <View style={styles.subContainer}>
          <Text style={styles.subText}>{"Protection plan"}</Text>
          <View style={styles.subPallet}>
            <View style={styles.planDes}>
              <Text style={[styles.fnt25, styles.boldText]}>{"Gold"}</Text>
              <Text style={styles.fnt16}>{"Premier Safety"}</Text>
            </View>
            <View style={styles.subPricing}>
              <Text style={[styles.fnt25, styles.boldText]}>{"$10.99 "}</Text>
