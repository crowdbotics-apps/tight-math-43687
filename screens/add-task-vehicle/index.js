  ...
  return <View style={styles.container}>
      <View style={styles.header}>
        <View style={styles.taskerProfile}>
          <Image source={{
          uri: "https://th.bing.com/th/id/OIP.hwnFQqAXUaTs2eEYWk929wHaD4?w=317&h=180&c=7&r=0&o=5&pid=1.7"
        }} style={styles.profileImage} />
          <View style={styles.taskerInfo}>
            <Text style={styles.taskerName}>{"St JC"}</Text>
        ...
        <View style={styles.taskInfo}>
          <Text style={styles.taskTitle}>{"St. Johnny Cash"}</Text>
          <Text style={styles.taskDescription}>{"Member of Guardian Angel, Free Ambulance Service"}</Text>
        </View>
      </View>
      <View style={styles.separator}>
        <Text style={styles.separatorText}>{"Make Records Accessible?"}</Text>
      </View>
...
const VehicleTile = props => {
  return <View style={vehicleTileStyles.vehicleTile}>
      ...
      <View style={vehicleTileStyles.vehicleInfo}>
        <Text style={vehicleTileStyles.vehicleType}>{"Medical and Family"}</Text>
        <Text>{"All My Medical Records, All of my family"}</Text>
